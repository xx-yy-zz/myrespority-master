...
public class MessageConstant {
    ...
    public static final String USER_IS_ASSOCATION = "用户被关联,不能删除";
    ...
    public static final String CHECKITEM_IS_ASSOCATION = "当前检查项被引用，不能删除";
    public static final String CHECKGROUP_IS_ASSOCATION = "当前检查组被引用，不能删除";
    ...
    public static final String PERMISSION_IS_ASSOCATION = "权限被关联,不可删除";
    ...
    public static final String ADD_MENU_SUCCESS = "增加列表数据成功";
    public static final String ADD_MENU_FAIL = "增加列表数据失败";
    public static final String EDIT_MENU_FAIL = "编辑列表数据失败";
    public static final String EDIT_MENU_SUCCESS = "编辑列表数据成功";
    public static final String DELETE_MENU_SUCCESS = "删除列表数据成功";
    public static final String DELETE_MENU_FAIL = "删除列表数据失败";
    public static final String DELETE_MENU_EXCEPTION = "外键约束,不能删除";
